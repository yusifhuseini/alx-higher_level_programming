...
* [html](./html): HTML folder containg html files used to test the js scripts.
...
* **13. And press ENTER**
  * [103-script.js](./103-script.js): JavaScript script that uses jQuery to fetch and
  display how to say "Hello" in a given language using the API
  `https://www.fourtonfish.com/hellosalut/hello/`. In this case, the tranlsation is fetched
